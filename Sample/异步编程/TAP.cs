...
/* TAP（Task-based Asynchronous Pattern）只使用一个方法就能表示异步操作的开始和完成。
一个以TaskAsync为后缀的方法，向该方法传入CancellationToken参数。可以通过IProgress<T>接口来实现进度报告的功能。
*/
using System;
using System.IO;
using System.Net;
...
namespace _20._5
{
    public partial class Form1 : Form
    {
        ...
        private void btnDownLoad_Click(object sender, EventArgs e)
        {
            ...
            sc.Post(new SendOrPostCallback(result => progressBar1.Value = (int)result), p)))); // 通过同步上文文的Post方法把更新UI的方法让主线程执行
